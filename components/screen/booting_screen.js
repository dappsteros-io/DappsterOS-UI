...
function BootingScreen(props) {
    ...
    return (
        <div style={(props.visible || props.isShutDown ? { zIndex: "100" } : { zIndex: "-20" })} className={(props.visible || props.isShutDown ? " visible opacity-100" : " invisible opacity-0 ") + " absolute duration-500 select-none flex flex-col justify-around items-center top-0 right-0 overflow-hidden m-0 p-0 h-screen w-screen bg-black"}>
            <img width="400px" height="400px" className="md:w-1/4 w-1/2" src="./images/logos/logo.svg" alt="Dappster Logo" />
            ...
            <h3 className="md:w-1/5 w-1/2 text-2xl text-white text-center">Dappster.io OS</h3>
            {/* <img width="200px" height="100px" className="md:w-1/5 w-1/2" src="/themes/Yaru/status/ubuntu_white_hex.svg" alt="Ubuntu Name" /> */}
           {/*  <div className="text-white mb-4">
                <a className="underline" href="https://www.linkedin.com/in/dappster/" rel="noreferrer noopener" target="_blank">linkedin</a>
                <span className="font-bold mx-1">|</span>
                <a href="https://github.com/dappster/dappster.github.io" rel="noreferrer noopener" target="_blank" className="underline">github</a>
            </div> */}
        </div>
    )
}
